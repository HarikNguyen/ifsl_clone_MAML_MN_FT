...
data_path = "/home/zhongqi/Dataset/imagenet/ILSVRC/Data/CLS-LOC/train"
savedir = "./"
...
filelists_flat_all = (
    filelists_flat["base"] + filelists_flat["val"] + filelists_flat["novel"]
)
labellists_flat_all = (
    labellists_flat["base"] + labellists_flat["val"] + labellists_flat["novel"]
)
